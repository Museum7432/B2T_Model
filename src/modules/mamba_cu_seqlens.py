...
class MambaVec2Vec(nn.Module):
    ...
    def forward(
        self, hidden_states, position_ids=None, cu_seqlens=None, inference_params=None, num_last_tokens=0
    ):
        """
        "position_ids" is just to be compatible with Transformer generation. We don't use it.
        num_last_tokens: if > 0, only return the logits for the last n tokens
        """
        hidden_states = self.backbone(hidden_states, cu_seqlens=cu_seqlens, inference_params=inference_params)
