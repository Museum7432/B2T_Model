...
sweep_configuration = {
    ...
    "parameters": {
        ...
        "encoder_n_layer": {"min": 5, "max": 7},
        "decoder_n_layer": {"min": 2, "max": 4},
        "peak_lr": {"values": [3e-4, 2e-4, 1e-4, 5e-5]},
        ##############################
        ...
        "gaussian_filter_sigma": {"values": [2, 1, 0.8, 0.5]},
